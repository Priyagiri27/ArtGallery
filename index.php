    ...
    <section class="my-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="Images/nat.jpg" alt="Card image" height="500px">
                        <div class="card-body">
                            <h4 class="card-title">Nature Painting</h4>
                            <p class="card-text">Water Color</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="Images/nat2.jpg" alt="Card image" height="500px">
                        <div class="card-body">
                            <h4 class="card-title">Nature Painting</h4>
                            <p class="card-text">Acrylic Painting</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card" style="width:400px">
                        <img class="card-img-top" src="Images/nat3.jpg" alt="Card image" height="500px">
                        <div class="card-body">
                            <h4 class="card-title">Nature Painting</h4>
                            <p class="card-text">Canvas Painting</p>
                        </div>
                    </div>
                </div>
            </div>
